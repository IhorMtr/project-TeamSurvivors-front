    ...
    <div className={css.wrapper}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
        ...
        <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
          ...
          <g id="round-conf">
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c1}`}
            ...
            />
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c2}`}
            ...
            />
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c3}`}
            ...
            />
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c4}`}
            ...
            />
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c5}`}
            ...
            />
            <path
              className={`${css['cls-1']} ${css.circle} ${css.c6}`}
        ...
        <g id="clock" data-name="Layer 8">
          ...
          />
          <rect
            className={`${css['cls-3']} ${css['clock-hand-1']}`}
            x="845"
            y="189.5"
            width="6.04"
            height="58"
          ...
          />
          <rect
            className={`${css['cls-3']} ${css['clock-hand-2']}`}
            x="845"
            y="209.5"
            width="6.04"
            height="38"
        ...
        <g id={css.bike} data-name="Layer 5">
          <path
            className={`${css['cls-8']} ${css.wheel}`}
